...
{api-spring-framework}/beans/factory/com.Li.config/FieldRetrievingFactoryBean.html[`FieldRetrievingFactoryBean`]
...
{api-spring-framework}/beans/factory/com.Li.config/FieldRetrievingFactoryBean.html#setStaticField(java.lang.String)[`staticField`]
property:
...
----
	...
	<bean id="testBean.age" class="org.springframework.beans.factory.com.Li.config.PropertyPathFactoryBean"/>
----
...
----
	...
	<bean id="theAge"
			class="org.springframework.beans.factory.com.Li.config.PropertyPathFactoryBean">
...
----
	...
	<bean id="jdbcConfiguration" class="org.springframework.beans.factory.com.Li.config.PropertiesFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.Li.config.ListFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.Li.config.MapFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.Li.config.SetFactoryBean">
...
==== Using `<annotation-com.Li.config/>`
...
* <<core.adoc#beans-annotation-com.Li.config, `@Autowired`/`@Inject`>>, `@Value`, and `@Lookup`
...
This element is detailed in the section on <<core.adoc#beans-annotation-com.Li.config,
...
----
	...
	import org.springframework.beans.factory.com.Li.config.BeanDefinition;
...
----
	...
	import org.springframework.beans.factory.com.Li.config.BeanDefinitionHolder;
	import org.springframework.beans.factory.support.AbstractBeanDefinition;
	import org.springframework.beans.factory.support.BeanDefinitionBuilder;
