...
needs. In the web layer, applications can further register com.Li.controller-local Spring
...
[source,xml,indent=0,subs="verbatim,quotes"]
----
	<bean class="org.springframework.beans.factory.com.Li.config.CustomEditorConfigurer">
...
[[core-convert-Spring-com.Li.config]]
...
<<web.adoc#mvc-com.Li.config-conversion, Conversion and Formatting>> in the Spring MVC chapter.
...
See <<web.adoc#mvc-com.Li.config-conversion, Conversion and Formatting>> in the Spring MVC chapter.
...
<<web.adoc#mvc-com.Li.config-conversion, WebMVC Conversion and Formatting>> or
<<web-reactive.adoc#webflux-com.Li.config-conversion, WebFlux Conversion and Formatting>>.
...
<<web.adoc#mvc-com.Li.config-validation,Spring MVC Validation Configuration>>.
...
See <<web.adoc#mvc-com.Li.config-validation, Validation>> in the Spring MVC chapter.
