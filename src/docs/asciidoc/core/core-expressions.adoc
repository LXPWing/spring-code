...
----
	...
	SpelParserConfiguration com.Li.config = new SpelParserConfiguration(true,true);

	ExpressionParser parser = new SpelExpressionParser(com.Li.config);
...
----
	...
	// - auto null reference initialization
	// - auto collection growing
	val com.Li.config = SpelParserConfiguration(true, true)

	val parser = SpelExpressionParser(com.Li.config)
...
.Java
----
	SpelParserConfiguration com.Li.config = new SpelParserConfiguration(SpelCompilerMode.IMMEDIATE,
		this.getClass().getClassLoader());

	SpelExpressionParser parser = new SpelExpressionParser(com.Li.config);
...
.Kotlin
----
	val com.Li.config = SpelParserConfiguration(SpelCompilerMode.IMMEDIATE,
