...
[[webtestclient-com.Li.controller-com.Li.config]]
=== Bind to Controller
...
The preceding example loads the <<web-reactive.adoc#webflux-com.Li.config, WebFlux Java configuration>>
and registers the given com.Li.controller. The resulting WebFlux application is tested
...
[[webtestclient-fn-com.Li.config]]
...
[[webtestclient-context-com.Li.config]]
...
[[webtestclient-server-com.Li.config]]
=== Bind to Server
...
[[webtestclient-client-com.Li.config]]
=== Client Builder
