...
[[mvc-cors-com.Li.controller]]
== `@CrossOrigin`
[.small]#<<web-reactive.adoc#webflux-cors-com.Li.controller, WebFlux>>#

The {api-spring-framework}/web/bind/annotation/CrossOrigin.html[`@CrossOrigin`]
annotation enables cross-origin requests on annotated com.Li.controller methods,
...
* All origins.
* All headers.
* All HTTP methods to which the com.Li.controller method is mapped.
...
In addition to fine-grained, com.Li.controller method level configuration, you probably want to
...
To enable CORS in the MVC Java com.Li.config, you can use the `CorsRegistry` callback,
as the following example shows:
...
.Java
----
	CorsConfiguration com.Li.config = new CorsConfiguration();

	// Possibly...
	// com.Li.config.applyPermitDefaultValues()

	com.Li.config.setAllowCredentials(true);
	com.Li.config.addAllowedOrigin("https://domain1.com");
	com.Li.config.addAllowedHeader("*");
	com.Li.config.addAllowedMethod("*");

	UrlBasedCorsConfigurationSource source = new UrlBasedCorsConfigurationSource();
	source.registerCorsConfiguration("/**", com.Li.config);
...
.Kotlin
----
	val com.Li.config = CorsConfiguration()

	// Possibly...
	// com.Li.config.applyPermitDefaultValues()

	com.Li.config.allowCredentials = true
	com.Li.config.addAllowedOrigin("https://domain1.com")
	com.Li.config.addAllowedHeader("*")
	com.Li.config.addAllowedMethod("*")
