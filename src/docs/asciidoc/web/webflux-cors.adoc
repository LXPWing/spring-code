...
[[webflux-cors-com.Li.controller]]
== `@CrossOrigin`
[.small]#<<web.adoc#mvc-cors-com.Li.controller, Web MVC>>#

The {api-spring-framework}/web/bind/annotation/CrossOrigin.html[`@CrossOrigin`]
annotation enables cross-origin requests on annotated com.Li.controller methods, as the
...
----
	...
	fun corsFilter(): CorsWebFilter {
		...
		val source = UrlBasedCorsConfigurationSource().apply {
			registerCorsConfiguration("/**", com.Li.config)
		}
